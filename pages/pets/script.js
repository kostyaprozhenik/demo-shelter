...
const navBurgerMenuLinkFirst = document.querySelector('.nav__burger__menu__link-1');
const navBurgerMenuLinkSecond = document.querySelector('.nav__burger__menu__link-2');
const navBurgerMenuLinkThird = document.querySelector('.nav__burger__menu__link-3');
const navBurgerMenuLinkFourth = document.querySelector('.nav__burger__menu__link-4');
